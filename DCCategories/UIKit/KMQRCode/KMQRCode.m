...
+(UIImage *)addQRCodeImageTobackImage:(UIImage *)image withBackImage:(UIImage *)backImage {
    UIGraphicsBeginImageContext(backImage.size);
        CGFloat widthOfImage  = image.size.width;
    CGFloat heightOfImage = image.size.height;
    CGFloat widthOfBackImage   = backImage.size.width;
    CGFloat heightOfBackImage  = backImage.size.height;
    
    [backImage drawInRect:CGRectMake(0, 0, widthOfBackImage, heightOfBackImage)];
    [image drawInRect:CGRectMake((widthOfBackImage - widthOfImage)/2, (heightOfBackImage-heightOfImage)/2,
